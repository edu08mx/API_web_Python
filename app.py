...
usuarios = [
    ...
    {"id": 3, "nome": "Usuario3", "cpf": "1234567", "age": "12"},
    {"id": 4, "nome": "Usuario4", "cpf": "12345678", "age": "13"},
    {"id": 5, "nome": "Usuario5", "cpf": "123456789", "age":"14"}
]
...
def cadastrar_usuario():
    ...
    if novo_id and novo_nome:
        ...
        novo_usuario = {"id": novo_id, "nome": novo_nome}
